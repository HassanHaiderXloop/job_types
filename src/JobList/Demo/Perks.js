...
// Code sahi hey bs es key End Points Nahi hyn
...
//     const fetchData = ()=>{
//       fetch(
//         `http://jobserviceelasticservice-env.eba-nivmzfat.ap-south-1.elasticbeanstalk.com/perk/all`
//       )
//       .then( async (response) =>{
...
//         fetch(
//           `http://jobserviceelasticservice-env.eba-nivmzfat.ap-south-1.elasticbeanstalk.com/perk/update/${key}`,
//           {
//             method: "POST",
//             headers: {
//               "Content-Type": "application/json",
//             },
//             body: JSON.stringify({perk: row.perk}),
//           },
...
//       `http://jobserviceelasticservice-env.eba-nivmzfat.ap-south-1.elasticbeanstalk.com/perk/add`,
//       {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
...
//     // );
//     fetch(
//       `http://jobserviceelasticservice-env.eba-nivmzfat.ap-south-1.elasticbeanstalk.com/perk/reactive/${record.id}`,
//       {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
...
//     fetch(
//       `http://jobserviceelasticservice-env.eba-nivmzfat.ap-south-1.elasticbeanstalk.com/perk/delete/${record.id}`,
//       {
//         method: "DELETE",
//         headers: {
//           "Content-Type": "application/json",
...
//       width: "38%",
//       editable: true,
//       render: (text, render)=>(<p>{render.perk}</p>),
//     },
//     {
//       title: "Action",
//       dataIndex: "Action",
...
//   return (
//     <>
//       <section className={styled.heading}> perk </section>
